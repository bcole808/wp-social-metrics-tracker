...
class TestFacebookGraphUpdater extends WP_UnitTestCase {
	...
	function setUp() {
		...
		$this->updater = $this->getMock('FacebookGraphUpdater', array('getURL'));
		...
		$this->offlineUpdater = $this->getMock('FacebookGraphUpdater', array('getURL'));
	...
	***************************************************/
	function test_get_total() {
		...
		$this->emptyResponseUpdater = $this->getMock('FacebookGraphUpdater', array('getURL'));
	...
	***************************************************/
	function test_circuit_breaker() {
		...
		$cb_updater = $this->getMock('FacebookGraphUpdater', array('getURL'));
